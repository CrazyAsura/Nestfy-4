  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground transition-colors duration-300 overflow-hidden cyber-grid">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 relative z-10">
        ...
        <div className="flex flex-col gap-4 mb-12 text-center md:text-left">
          ...
          <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tight">
            Cookies & Cache <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-neon-blue to-white neon-text-glow">Policy</span>
          </h1>
          <p className="text-sm text-zinc-400 font-light leading-relaxed max-w-xl">
            Detailed registry of storage block metrics and local cache expirations.
          </p>
        </div>
        ...
        <GlassCard animate={false} className="border border-zinc-900 bg-zinc-950/20 mb-8 flex gap-4">
          ...
          <div>
            <h3 className="text-sm font-bold uppercase tracking-wider text-white font-mono">Dynamic Cache Strategy</h3>
            <p className="text-xs text-zinc-400 leading-relaxed font-light mt-1">
              Our PWA storefront uses client-side cache and cookies to manage your navigation states, prevent loading delays, and secure your encrypted checkout payloads. You can configure performance and analytics caches at any time via the deck launcher in the bottom right corner.
            </p>
          </div>
        </GlassCard>
            ...
            <table className="w-full text-left border-collapse text-xs font-mono">
              <thead>
                <tr className="bg-zinc-950 border-b border-zinc-900 text-zinc-500 uppercase tracking-widest text-[9px] font-black">
                  <th className="p-4">Cookie Block</th>
              ...
              <tbody className="text-zinc-300 divide-y divide-zinc-950">
                <tr className="hover:bg-zinc-950/40 transition-colors">
                  ...
                  <td className="p-4 text-neon-blue font-black">REQUIRED</td>
                  <td className="p-4 font-light text-zinc-400">Stores active cart arrays, items, and quantities for purchase.</td>
                  <td className="p-4">30 Days</td>
                </tr>
                <tr className="hover:bg-zinc-950/40 transition-colors">
                  <td className="p-4 font-bold text-white uppercase">nestfy-cookie-consent</td>
                  <td className="p-4 text-neon-blue font-black">REQUIRED</td>
                  <td className="p-4 font-light text-zinc-400">Stores your customized cookie consent preferences.</td>
                  <td className="p-4">365 Days</td>
                </tr>
                <tr className="hover:bg-zinc-950/40 transition-colors">
                  <td className="p-4 font-bold text-white uppercase">theme-cache-config</td>
                  <td className="p-4 text-white font-medium">PERFORMANCE</td>
                  <td className="p-4 font-light text-zinc-400">Caches page layout layouts and dark theme selectors to avoid styling flashes.</td>
                  <td className="p-4">Persistent</td>
                </tr>
                <tr className="hover:bg-zinc-950/40 transition-colors">
                  <td className="p-4 font-bold text-white uppercase">catalog-telemetry-log</td>
                  <td className="p-4 text-zinc-500 font-medium">ANALYTICS</td>
                  <td className="p-4 font-light text-zinc-400">Anonymously tracks scrolling speeds and categories filtered to optimize load operations.</td>
        ...
        <div className="flex gap-2.5 items-center text-[10px] font-mono text-zinc-500">
          ...
          <span>Matter protocol devices in your home do not read or communicate with browser storefront cookies.</span>
        </div>
      ...
      <footer className="border-t border-zinc-950 py-8 text-center text-[10px] tracking-widest text-zinc-700 uppercase font-mono mt-16">
        NESTFY SYSTEMS © 2026. COOKIE_INDEX_OK.
      </footer>
    </div>
  );
}
