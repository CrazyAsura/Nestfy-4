...
@Getter
@Setter
public abstract class IOrderEntity {

    public abstract Long getId();
    public abstract void setId(Long id);

    public abstract CartEntity getCart();
    public abstract void setCart(CartEntity cart);

    public abstract ClientEntity getClient();
    public abstract void setClient(ClientEntity client);

    public abstract List<ProductEntity> getProduct();
    public abstract void setProduct(List<ProductEntity> product);
